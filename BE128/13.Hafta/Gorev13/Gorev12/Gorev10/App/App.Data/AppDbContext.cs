    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>().HasData(
                ...
                new Role { Id = 2, Name = "customer", CreatedAt = seedDate }
            );
            // Sadece superadmin seed
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, Email = "admin@admin.com", FirstName = "Admin", LastName = "User", Password = "admin123", RoleId = 1, Enabled = true, CreatedAt = seedDate }
            );
