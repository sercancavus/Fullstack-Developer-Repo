...
---
## 8. Güvenlik / İyileştirme Notları
- Parolalar plaintext -> hash (Identity veya PBKDF2 / BCrypt) zorunlu.
- Auth + Role bazlı yetki eklenmeli.
- Validation katmanı (ör. FluentValidation) düşünülmeli.
- Concurrency & transaction (özellikle stok ve sipariş) ele alınmalı.
- Giriş/çıkış loglama + hata yakalama middleware’i lazım.
...
- Yönetim (kategori / ürün CRUD) henüz gerçek değil.
